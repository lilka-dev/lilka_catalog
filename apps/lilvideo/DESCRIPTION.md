...
Little video player for Lilka board that allows playback of specially prepared videos with sound (MJPEG + AAC).
...
Ну або просто скачайте готовий файл [player.bin](https://github.com/noisedsn/lilvideo/blob/main/player.bin).
